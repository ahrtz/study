    ...
    for k in range (M):
        ...
        while True:
            ...
            if 0 <= new_row < N and pan[new_row][ccol]!=color and pan[new_row][ccol]!=0:
                rrow = new_row
            elif 0 <= new_row < N and pan[new_row][ccol] == 0:
                break
            elif 0<= new_row < N and pan[new_row][ccol]==color:
                tmprow=new_row
        ...
        while True:
            ...
            if 0 <= new_col < N and 0 <= new_row < N and pan[new_row][new_col]!=color and pan[new_row][new_col]!=0:
                ccol = new_col
                rrow = new_row
            elif 0 <= new_col < N and 0 <= new_row < N and pan[new_row][new_col] == 0:
                break
            elif 0 <= new_col < N and 0 <= new_row < N and pan[new_row][new_col]==color:
                tmpcol = new_col
                tmprow = new_row
                for tttt in range(0,tmpcol-ccol):
                    pan[rrow-tttt][ccol+tttt]=color
                break
            elif new_row<0 or new_col>=N:
                break
        rrow = row - 1
        ccol = col - 1
        while True:
